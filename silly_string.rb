...
lowercased_phrase = phrase.downcase # Put a .downcase after phrase and use a String method.
...
bigger_word = big_word + "wow" + "mom"# put a .Capitalize Use String concatenation to add "wow" and "mom" to big_word
...
proper_sentence = "i really like programming.".capitalize # .capitalize Put a . after the string to capitalize it properly.
...
sentence = sentence.gsub("A","O").gsub("a","o") # put a .swapcase Add your gsub chain here
